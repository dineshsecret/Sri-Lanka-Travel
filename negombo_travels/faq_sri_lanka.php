...
<title>FAQs Negombo travels</title>
</head>
<body>
<!-- wrap starts here -->
...
<!-- LEFT NAVIGATION HERE -->	
 <?php include_once('includes/left_nav.php');?>
	  ...
	  <div id="main">	
		...
		<p><strong>Why should we trust Negombo Travel to arrange our holiday?</strong></p>
		...
		<p>The main Sri Lanka sales and operations teams for Negombo Tours are based in Colombo. We also have a support network in India. This enables us to offer up-to-the-minute advice and highly competitive prices, as well as supporting the local economy. We can deal effectively with enquiries from anywhere in the world. We prefer that you contact us initially by email by using the Contact Us form (or for simpler enquiries on tours@srilankanegombo.com). This method is not as impersonal as it sounds! Whenever you need to discuss your holiday with a consultant, simply phone one of these numbers:</p>
