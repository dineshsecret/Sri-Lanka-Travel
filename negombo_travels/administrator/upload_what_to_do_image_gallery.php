...
$last_insert_id			= $_GET['last_insert_id'];
...
<?php include('includes/header.php');?>
	...
	<div id="content-wrap">
	  ...
	  <a name="TemplateInfo"></a> <div id="side_bar_heading"> <a href="accommodation.php">Accommodation Panel</a><br />
	      <br />
	      <form id="form1" method="post" action="form_action.php" enctype="multipart/form-data">
	        <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="25%" height="15"><u>Upload Images </u></td>
                <td width="75%" height="7"><input name="image_f" type="file" class="tiny_text" id="image_f" size="35" />
                <br /></td>
              </tr>
              <tr>
                <td height="30">
                <input type="hidden" name="page_name" value="what_to_do"  />
                <input type="hidden" name="mod" value="update_what_do_images" /> 
                ...
                <td height="30"><input name="button" type="submit" class="tiny_text" id="button" value="Upload images" /></td>
              </tr>
            </table>
        </form>
	  </div>	
