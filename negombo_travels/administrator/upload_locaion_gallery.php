...
$last_inserted_accom_id = $_GET['last_insert_id'];
	      ...
	      <form id="form1" method="post" action="form_action.php" enctype="multipart/form-data">
	        <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="75%" height="7"><input name="image_f" type="file" class="textfield" id="image_f" size="35" /></td>
              </tr>
              <tr>
                <td height="30">
                <input type="hidden" name="page_name" value="accommodation"  />
                <input type="hidden" name="mod" value="insert_location_images" /> 
