...
if(isset($_GET['last_insert_accom_id']))
{
...
<?php include('includes/header.php');?>
	...
	<div id="content-wrap">
	  ...
	  <a name="TemplateInfo"></a> <div id="side_bar_heading"> <a href="itenaries.php">Destination Panel</a>  | Excursions<br />
	      <br />
	      <form id="form1" method="post" action="form_action.php" enctype="multipart/form-data">
	        <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <input type="hidden" name="mod" value="insert_experiance_images" /> 
