...
$destination_edit_exe	= $destination_edit->Destination_Edit($destination_id);
	  ...
	  <a name="TemplateInfo"></a> <div id="side_bar_heading"><a href="new_destination.php">Destination Panel</a><br />
		  ...
		  ?>
              ...
              <tr>
                ...
                <p><a href="upload_destination_gallery.php?last_insert_id=<?php echo $destination_id;?>">Upload Thum Images</a></p></td>
              </tr>
              <tr>
                <td width="25%" height="30">
                <input type="hidden" name="page_name" value="destination"  />
                <input type="hidden" name="mod" value="edit_destination_acs" /> <input type="hidden" name="edit_id" value="<?php echo $destination_id;?>" /></td>
