	  ...
	  <a name="TemplateInfo"></a> <div id="side_bar_heading">Add New Attraction<br />
	      ...
	      <form id="form1" method="post" action="form_action.php" enctype="multipart/form-data">
	        <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td height="35"> :
                  <input name="event_name" type="text" id="attract_name" size="50" /><span class="error">
				<?php 
				if($_SESSION['accom']){
						echo($_SESSION['accom']);
		  ...
		  ?>
              ...
              <tr>
                ...
                <td height="36"><input name="sta_date" type="text" id="sta_date" maxlength="10" /></td>
              </tr>
              <tr>
                <td height="36">Ending date </td>
                <td height="36"><input name="end_date" type="text" id="end_date" maxlength="10" /></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <input type="hidden" name="mod" value="event_act" /></td>
              ...
              <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#EFEFEF">
                  ...
                  <tr>
                    ...
                    <td width="131" align="center" bgcolor="#000000"><a href="edit_events.php?id=<?php echo $my_experiance_rec['event_id'];?>">Edit</a></td>
