            ...
            <div id="content-wrap">
              <div id="sidebar" >
                    ...
                    <div id="main">
                        ...
                        <a name="TemplateInfo"></a> <div id="side_bar_heading"><a href="what_to_see_dash.php?city_id=<?php echo $city_id;?>&what_to_see_id=<?php echo $what_to_see_cat_id;?>">Attaraction Pane </a>   | Edit Attraction (To Do )Information<br />
<?php if (isset($_SESSION['accom_success'])) {
    ...
    unset($_SESSION['accom_success']);
                            ...
                            <form id="form1" method="post" action="form_action.php"  enctype="multipart/form-data">
                                ...
                                $attraction_pane = $attraction->Attraction_Editable_ToDo($to_do_id);
								?>
                                ...
                                <?php 
                                 while($each_recset_excursion = mysql_fetch_assoc($attraction_pane)){
                                  ...
                                  <tr>
                                    <td height="25"> To Do Activity Name </td>
                                    <td height="25">:
                                      <input name="ex_name" type="text" id="to_do_name" size="50" value="<?php echo($each_recset_excursion['to_do_name']); ?>" /></td>
                                  </tr>
                                  <tr>
                                    <td height="25">To Do Activity Situated At </td>
                                    <td height="25">:
                                  ...
                                  <?php } ?>
                                  <tr>
                                    <td height="25"><input type="hidden" name="page_name" value="what_to_do"  />
                                      <input type="hidden" name="mod" value="edit_ToDo_info" />
                                      <input type="hidden" name="city_id" value="<?php echo $city_id;?>" />
                                      <input type="hidden" name="to_do_id" value="<?php echo $to_do_id;?>" /> 
                                      <input type="hidden" name="what_to_do_cat_id" value="<?php echo $what_to_do_cat_id ;?>" />
                                      <br />
                                      <br /></td>
