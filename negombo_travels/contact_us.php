...
<!-- LEFT NAVIGATION HERE -->	
 <?php include_once('includes/left_nav.php');?>
	  ...
	  <div id="main">	
		...
		<h2><span class="green">Negombo Travles Contact Details</span></h2>
		<form name="user_details" id="user_details" action="form_actions.php" method="POST"><?php 
    ...
    <tr>
      <td width="225" height="27">First Name<span class="green"> *</span> : </td>
    ...
    <tr>
      ...
      <td height="27"><input name="txt_mname" type="text" id="txt_mname" style="width:100%;" size="30" /></td>
    </tr>
    <tr>
      <td height="27">Last Name<span class="green">*</span> :</td>
      <td height="27"><span class="green"><input name="txt_lname" type="text" id="txt_lname" style="width:100%;" size="20" /></span></td>
    </tr>
    ...
    <tr>
      <td height="27">Address Line 1 :</td>
      <td height="27"><input name="txt_add1" type="text" id="txt_add1" style="width:100%;" size="30" /></td>
    </tr>
    <tr>
      <td height="27">Address Line 2 :</td>
      <td height="27"><input name="txt_add2" type="text" id="txt_add2" style="width:100%;" size="30" /></td>
    </tr>
    
    
    <tr>
      <td height="27">Country <span class="green">*</span> :</td>
      <td height="27"><select name="txt_country" class="Text_normal85" id="txt_country"> 
    ...
    <tr>
      <td height="27">Tel<span class="green"> *</span> :</td>
      <td height="27"><span class="green"><input name="txt_tel" type="text" id="txt_tel" style="width:180px;" size="12" /></span></td>
    </tr>
    <tr>
      <td height="27">Mobile :</td>
      <td height="27"><input name="txt_mob" type="text" id="txt_mob" style="width:180px;" size="14" /></td>
    </tr>
    <tr>
      <td height="27">E-mail<span class="green"> *</span> :</td>
      <td height="27"><span class="green"><input type="text" name="txt_email" id="txt_email" style="width:180px;" /></span></td>
    </tr>
    <tr>
      <td height="44">Inquiry </td>
      <td height="44"><textarea name="textarea"></textarea></td>
    </tr>
    
    <tr>
      <td height="27"><input name="mod" type="hidden" id="mod" value="contact_form"></td>
      <td height="27"><label>
        ...
        <input name="Submit2" type="reset" class="style2" value="Reset" />
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="98%" valign="top"><p><strong><u>Sri Lanka</u> </strong><br />
