...
Lightbox.prototype = {
	...
	initialize: function() {	
		...
		//						<img src="../../Copy of what_to_do/js/images/loading.gif">
		//					</a>
		//				</div>
		//			</div>
		//		</div>
		...
		//						<img src="../../Copy of what_to_do/js/images/close.gif">
		//					</a>
		//				</div>
		//			</div>
		//		</div>
	...
	start: function(imageLink) {	
		...
		function getImageTitle(anchor){ //DynamicDrive.com added function that allows the caption("title") to be linked ("rev").
			...
			return ddimageTitleFinal=(ddimageTitleURL!=null && ddimageTitleURL!="")? '<a href="../../Copy of what_to_do/js/'+ddimageTitleURL+'" class="ddcaptionurl">'+ddimageTitle+'</a>' : ddimageTitle
		};
