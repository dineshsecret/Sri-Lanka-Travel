...
<title>Guests comments about Negombo Travels</title>
</head>
<body>
<!-- wrap starts here -->
...
<!-- LEFT NAVIGATION HERE -->	
 <?php include_once('includes/left_nav.php');?>
	  ...
	  <div id="main">	
		    ...
		    <h2><span class="green">Guest Recommendations</span><a id="tips"></a></h2> 
		    <p><a href="">post your comment</a></p>
        <form name="user_details" id="user_details" action="form_actions.php" method="POST">
          <table width="500" border="0" cellspacing="0" cellpadding="0">
    
    <tr>
      <td width="171" height="27">Full Name : </td>
      <td width="329" height="27"><input name="txt_fname" type="text" id="txt_fname" style="width:100%;"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td height="20"><input type="text" name="txt_email" id="txt_email" style="width:180px;" /></td>
    </tr>
    
    <tr>
      <td height="44">Comments </td>
      <td height="44"><textarea name="comments" cols="30" rows="6" id="comments"></textarea></td>
    </tr>
    
    <tr>
      <td height="35">User verification </td>
      <td height="35">8 + 12 = 
        <input name="answer" type="text" id="answer" size="3" maxlength="3" /><span class="green">
		<?php 
    ...
    <tr>
      <td height="27"><input name="mod" type="hidden" id="mod" value="g_comments"></td>
      <td height="27"><label>
        <input type="submit" class="style2" value="Submit Form"/>
        <input name="Submit2" type="reset" class="style2" value="Reset" />
      <span class="green">
		<?php 
		if(isset($_SESSION['post_suc'])){
		print $_SESSION['post_suc'];
